...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/wsTimbradoTexto.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">wsTimbradoTexto</p><br>

      

      <span>

          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="wsTimbradoTexto.asmx?WSDL">Service Description</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="wsTimbradoTexto.asmx?op=TextoAXml">TextoAXml</a>
              ...
              <li>
                <a href="wsTimbradoTexto.asmx?op=timbradoPorTexto">timbradoPorTexto</a>
              ...
              <li>
                <a href="wsTimbradoTexto.asmx?op=timbradoPorTextoNomina">timbradoPorTextoNomina</a>
