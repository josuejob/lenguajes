using service = WindowsFormsApplication1.PruebasWsTimbradoTexto33;
...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void llamarWebservice_Click(object sender, EventArgs e) 
        {
            try
            {
                //Declarando el WEbSErvice
                service.wsTimbradoTexto33 ws = new service.wsTimbradoTexto33();
                ...
                path = @"C:\ruta_destino\EjemploFacturaCadenaTexto.txt";// Cadena de texto con los datos requeridos para convertir a xml, en caso de recibir el error de que este comprobante ya fue timbrado, favor de cambiar el Numero de Folio o Otro campo con finalidad de cambiar la cadena original del XML 

                StreamReader sr = new StreamReader(path, System.Text.Encoding.Default);
                string CadenaTexto = sr.ReadToEnd();
                sr.Close();
                ...
                v = ws.SellarTimbrarPorTexto33("demo.sifec@gmail.com", "Acceso$01", "511110", CadenaTexto, cer, key, "12345678a");
                ...
                else
                {
                    ...
                    File.WriteAllBytes(@"C:\ruta_destino\xmlSelladoTimbradoDeTexto.xml", v.XML);

                    //Dependiento el tipo de timbrado este puede contener su version en PDF
                    if (v.PDF != null) {

                            File.WriteAllBytes(@"C:\ruta_destino\xmlSelladoTimbradoDeTexto.pdf", v.PDF);
                    }
        ...
        private void timbrar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String path = @"C:\ruta_destino\EjemploFacturaCadenaTexto.txt";// Cadena de texto con los datos requeridos para convertir a xml, en caso de recibir el error de que este comprobante ya fue timbrado, favor de cambiar el Numero de Folio o Otro campo con finalidad de cambiar la cadena original del XML 
                ...
                // Proceso   : Este numero de proceso se le proporcionara dependiendo de su tipo de timbrado "511110" convierte txt a xml,sella y timbra mas Pdf
                // CadenaTexto: Este parametro resive una cadena en string que contiene los datos para generar el xml
                v = ws.TimbrarPorTexto33("demo.sifec@gmail.com", "Acceso$01", "511110", CadenaTexto); 
                ...
                else 
                {
                    ...
                    path = @"C:\ruta_destino\xmlSelladoTimbradoDeTexto.xml";
                    File.WriteAllBytes(path, v.XML);

                    //Dependiento el tipo de timbrado este puede contener su version en PDF
                    if (v.PDF != null)
                    {                      
                            File.Delete(@"C:\ruta_destino\xmlSelladoTimbradoDeTexto.pdf");
                            File.WriteAllBytes(@"C:\ruta_destino\xmlSelladoTimbradoDeTexto.pdf", v.PDF);
                    }
                }
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Para este tipo de cancelacion el cer y key deben de cargarse en el portal web ya que con requeridos para cancelar ante el SAT
                v = ws.Cancelar33EncodeCSD("demo.sifec@gmail.com", "Acceso$01", "LAN7008173R5", "96d8d738-8767-4b90-a2f0-67e6cfbd64c3", cer, pem);
                if (v.errores != "")
                {
                    Cancelar.Text = v.errores;
                }
